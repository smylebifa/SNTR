  ...
  <div class="container">
    ...
    if ($sql_select) {
      ...
      foreach ($sql_select as $row) {
        ...
        echo '<tr>
        <td> <a href="/okved_level3.php?code=' . $row->КодОквэд2Уровень . '">' . $row->КодОквэд2Уровень . '</a></td>
        <td> <a href="/okved_level3.php?code=' . $row->КодОквэд2Уровень . '">' . $row->НазваниеОквэд . '</a></td>
        </tr>';
      }
