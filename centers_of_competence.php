        ...
        if ($country === '') {
          ...
          // Поиск по приоритету...
            ...
            $sql_select = $wpdb->get_results($wpdb->prepare("
              SELECT ЦентрыКомпетенций.НазваниеЦентра, ЦентрыКомпетенций.Страна,  ЦентрыКомпетенций.НазваниеКомпетенции, ЦентрыКомпетенций.Приоритет, КодыКомпетенций.НазваниеКомпетенции
        ...
        // Поиск по стране...
          ...
          if ($priority === '') {
            $sql_select = $wpdb->get_results($wpdb->prepare("
              ...
              GROUP BY 
              ЦентрыКомпетенций.НазваниеЦентра, ЦентрыКомпетенций.Страна,  ЦентрыКомпетенций.НазваниеКомпетенции, ЦентрыКомпетенций.Приоритет
              WHERE ЦентрыКомпетенций.Страна = %s", $country));
          }
          ...
          // Поиск по стране, приоритету...
            ...
            $sql_select = $wpdb->get_results($wpdb->prepare("
              ...
              ЦентрыКомпетенций.НазваниеЦентра, ЦентрыКомпетенций.Страна,  ЦентрыКомпетенций.НазваниеКомпетенции, ЦентрыКомпетенций.Приоритет
              WHERE
              ЦентрыКомпетенций.Страна = %s 
              AND ЦентрыКомпетенций.Приоритет = %s", [$country, $priority]));
          }
        ...
        if ($country === '') {
          ...
          if ($priority === '') {
            $sql_select = $wpdb->get_results($wpdb->prepare("
              ...
              ЦентрыКомпетенций.НазваниеКомпетенции = %s", $name_of_competency));
          }
          ...
          // Поиск по компетенции и приоритету...
            ...
            $sql_select = $wpdb->get_results($wpdb->prepare("
             ...
             ЦентрыКомпетенций.НазваниеЦентра, ЦентрыКомпетенций.Страна,  ЦентрыКомпетенций.НазваниеКомпетенции, ЦентрыКомпетенций.Приоритет
             WHERE
             ЦентрыКомпетенций.НазваниеКомпетенции = %s 
             AND ЦентрыКомпетенций.Приоритет = %s", [$name_of_competency, $priority]));
          }
          ...
          if ($priority === '') {
            $sql_select = $wpdb->get_results($wpdb->prepare("
              ...
              AND ЦентрыКомпетенций.Страна = %s", [$name_of_competency, $country]));
          }
          ...
          // Поиск по компетенции, стране, приоритету...
            ...
            $sql_select = $wpdb->get_results($wpdb->prepare("
             ...
             AND ЦентрыКомпетенций.Приоритет = %s", [$name_of_competency, $country, $priority]));
          }
